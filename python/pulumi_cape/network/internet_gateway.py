...
class InternetGatewayArgs:
    def __init__(__self__, *,
                 spec: pulumi.Input['_schemas.InternetGatewaySpecArgs'],
        ...
        :param pulumi.Input['_schemas.InternetGatewaySpecArgs'] spec: The internet gateway will use the reserved IP addres. the subnet CIDR block to provide internet access to the subnet.
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input['_schemas.InternetGatewaySpecArgs']:
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input['_schemas.InternetGatewaySpecArgs']):
...
@pulumi.type_token("cape:network:InternetGateway")
class InternetGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 extensions: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 spec: pulumi.Input[Optional[Union['_schemas.InternetGatewaySpecArgs', '_schemas.InternetGatewaySpecArgsDict', '_schemas.outputs.InternetGatewaySpec']]] = None,
                 tenant: pulumi.Input[Optional[_builtins.str]] = None,
                 workspace: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] extensions: User-defined key/value pairs that are mutable and can be used to add extensions. Extensions are subject to validation by the CSP, and any value that is not accepted will be rejected during admission.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: User-defined key/value pairs that are mutable and can be used to organize and categorize resources. They can be used to filter resources. The number of labels is eventually limited by the CSP.
        :param pulumi.Input[Union['_schemas.InternetGatewaySpecArgs', '_schemas.InternetGatewaySpecArgsDict', '_schemas.outputs.InternetGatewaySpec']] spec: The internet gateway will use the reserved IP addres. the subnet CIDR block to provide internet access to the subnet.
        :param pulumi.Input[_builtins.str] tenant: The tenant for the resource. If omitted, the provider default is used.
        :param pulumi.Input[_builtins.str] workspace: The workspace for the resource. If omitted, the provider default is used. Must be configured by either means.
        """
        ...
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['_schemas.outputs.InternetGatewaySpec']:
        """
        The internet gateway will use the reserved IP addres. the subnet CIDR block to provide internet access to the subnet.
        """
        return pulumi.get(self, "spec")
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output['_schemas.outputs.InternetGatewayStatus']:
        """
