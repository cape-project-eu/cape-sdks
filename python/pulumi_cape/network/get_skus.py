...
class GetSkusResult:
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['_schemas.outputs.NetworkSku']:
...
def get_skus(labels: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cape:network:getSkus', __args__, opts=opts, typ=GetSkusResult).value
...
def get_skus_output(labels: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cape:network:getSkus', __args__, opts=opts, typ=GetSkusResult)
