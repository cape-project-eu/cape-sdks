...
class NetworkLoadBalancerArgs:
    def __init__(__self__, *,
                 spec: pulumi.Input['_schemas.NetworkLoadBalancerSpecArgs'],
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input['_schemas.NetworkLoadBalancerSpecArgs']:
        """
        Defines the specification for a Network Load Balancer. A Load Balancer can have multiple frontends, where each frontend may target multiple backend instances. Frontend ports and protocols must be unique to ensure proper routing. The NIC associated with the proxy determines whether the Load Balancer is internal or external.
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input['_schemas.NetworkLoadBalancerSpecArgs']):
...
@pulumi.type_token("cape:loadbalancer:NetworkLoadBalancer")
class NetworkLoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 extensions: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 spec: pulumi.Input[Optional[Union['_schemas.NetworkLoadBalancerSpecArgs', '_schemas.NetworkLoadBalancerSpecArgsDict', '_schemas.outputs.NetworkLoadBalancerSpec']]] = None,
                 tenant: pulumi.Input[Optional[_builtins.str]] = None,
                 workspace: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] extensions: User-defined key/value pairs that are mutable and can be used to add extensions. Extensions are subject to validation by the CSP, and any value that is not accepted will be rejected during admission.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: User-defined key/value pairs that are mutable and can be used to organize and categorize resources. They can be used to filter resources. The number of labels is eventually limited by the CSP.
        :param pulumi.Input[Union['_schemas.NetworkLoadBalancerSpecArgs', '_schemas.NetworkLoadBalancerSpecArgsDict', '_schemas.outputs.NetworkLoadBalancerSpec']] spec: Defines the specification for a Network Load Balancer. A Load Balancer can have multiple frontends, where each frontend may target multiple backend instances. Frontend ports and protocols must be unique to ensure proper routing. The NIC associated with the proxy determines whether the Load Balancer is internal or external.
        :param pulumi.Input[_builtins.str] tenant: The tenant for the resource. If omitted, the provider default is used.
        :param pulumi.Input[_builtins.str] workspace: The workspace for the resource. If omitted, the provider default is used. Must be configured by either means.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        super(NetworkLoadBalancer, __self__).__init__(
            'cape:loadbalancer:NetworkLoadBalancer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NetworkLoadBalancer':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['_schemas.outputs.NetworkLoadBalancerSpec']:
        """
        Defines the specification for a Network Load Balancer. A Load Balancer can have multiple frontends, where each frontend may target multiple backend instances. Frontend ports and protocols must be unique to ensure proper routing. The NIC associated with the proxy determines whether the Load Balancer is internal or external.
        """
        return pulumi.get(self, "spec")
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output['_schemas.outputs.NetworkLoadBalancerStatus']:
        """
