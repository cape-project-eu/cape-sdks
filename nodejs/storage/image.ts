...
export class Image extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cape:storage:Image';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.schemas.ImageSpec>;
    /**
     * Status of the Image, including the size of the Image in MB.
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.schemas.ImageStatus>;
    /**
    ...
    constructor(name: string, args: ImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["spec"] = args ? pulumi.output(args.spec).apply(inputs.schemas.imageSpecArgsProvideDefaults) : undefined;
...
export interface ImageArgs {
     ...
     * Detailed specification of the Image resource. The Image is derived from a block storage resource identified by `blockStorageRef` and serves as a template for creating compute instances. For additional information, refer to the [Image Handling](/docs/content/Other/image-handling) section.
     */
    spec: pulumi.Input<inputs.schemas.ImageSpecArgs>;
    /**
     * The tenant for the resource. If omitted, the provider default is used.
     */
