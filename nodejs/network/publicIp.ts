...
export class PublicIp extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PublicIp {
        return new PublicIp(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cape:network:PublicIp';
     ...
     */
    declare public readonly spec: pulumi.Output<outputs.schemas.PublicIpSpec>;
    /**
     * Status of the public IP.
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.schemas.PublicIpStatus>;
    /**
...
export interface PublicIpArgs {
     ...
     * Specification of the public IP.
     */
    spec: pulumi.Input<inputs.schemas.PublicIpSpecArgs>;
    /**
     * The tenant for the resource. If omitted, the provider default is used.
     */
