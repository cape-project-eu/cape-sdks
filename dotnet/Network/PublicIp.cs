...
namespace Pulumi.Cape.Network
{
    ...
    /// Public IP resource.
    /// </summary>
    [CapeResourceType("cape:network:PublicIp")]
    public partial class PublicIp : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Cape.Schemas.Outputs.PublicIpSpec> Spec { get; private set; } = null!;

        /// <summary>
        /// Status of the public IP.
        /// </summary>
        [Output("status")]
        public Output<Pulumi.Cape.Schemas.Outputs.PublicIpStatus> Status { get; private set; } = null!;
        ...
        public PublicIp(string name, PublicIpArgs args, CustomResourceOptions? options = null)
            : base("cape:network:PublicIp", name, args ?? new PublicIpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cape:network:PublicIp", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PublicIp Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class PublicIpArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Cape.Schemas.Inputs.PublicIpSpecArgs> Spec { get; set; } = null!;
