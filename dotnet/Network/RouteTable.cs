...
namespace Pulumi.Cape.Network
{
    ...
    /// </summary>
    [CapeResourceType("cape:network:RouteTable")]
    public partial class RouteTable : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Cape.Schemas.Outputs.RouteTableSpec> Spec { get; private set; } = null!;
        ...
        /// </summary>
        [Output("status")]
        public Output<Pulumi.Cape.Schemas.Outputs.RouteTableStatus> Status { get; private set; } = null!;
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("cape:network:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cape:network:RouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteTableArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Cape.Schemas.Inputs.RouteTableSpecArgs> Spec { get; set; } = null!;
