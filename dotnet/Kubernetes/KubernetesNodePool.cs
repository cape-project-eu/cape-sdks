...
namespace Pulumi.Cape.Kubernetes
{
    /// <summary>
    ...
    /// </summary>
    [CapeResourceType("cape:kubernetes:KubernetesNodePool")]
    public partial class KubernetesNodePool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Cape.Schemas.Outputs.KubernetesNodePoolSpec> Spec { get; private set; } = null!;
        ...
        /// </summary>
        [Output("status")]
        public Output<Pulumi.Cape.Schemas.Outputs.KubernetesNodePoolStatus> Status { get; private set; } = null!;
        ...
        public KubernetesNodePool(string name, KubernetesNodePoolArgs args, CustomResourceOptions? options = null)
            : base("cape:kubernetes:KubernetesNodePool", name, args ?? new KubernetesNodePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesNodePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cape:kubernetes:KubernetesNodePool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class KubernetesNodePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Cape.Schemas.Inputs.KubernetesNodePoolSpecArgs> Spec { get; set; } = null!;
