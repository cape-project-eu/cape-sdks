...
namespace Pulumi.Cape.Kubernetes
{
    ...
    /// </summary>
    [CapeResourceType("cape:kubernetes:KubernetesCluster")]
    public partial class KubernetesCluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("spec")]
        public Output<Pulumi.Cape.Schemas.Outputs.KubernetesClusterSpec> Spec { get; private set; } = null!;

        /// <summary>
        /// Represents the status of the kubernetes cluster.
        /// </summary>
        [Output("status")]
        public Output<Pulumi.Cape.Schemas.Outputs.KubernetesClusterStatus> Status { get; private set; } = null!;
        ...
        public KubernetesCluster(string name, KubernetesClusterArgs args, CustomResourceOptions? options = null)
            : base("cape:kubernetes:KubernetesCluster", name, args ?? new KubernetesClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cape:kubernetes:KubernetesCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class KubernetesClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Cape.Schemas.Inputs.KubernetesClusterSpecArgs> Spec { get; set; } = null!;
