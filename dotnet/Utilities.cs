...
namespace Pulumi.Cape
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Cape.version.txt");
    ...
    internal sealed class CapeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CapeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
